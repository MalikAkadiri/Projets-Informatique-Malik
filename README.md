...
- Les projets de développement nécessitent l'installation de Python 3 sur votre système.
- Pour vérifier la validité des fonctions de la SAE 1.02, l'outil pytest peut être utilisé pour lancer les tests fournis.
- Le site web de la SAE 2.06 peut être consulté en ouvrant le fichier index.html avec un navigateur moderne tel que Firefox.
